...
const IncomeVsExpenseChart = ({ trendsData = [] }) => {
    ...
    <div className="p-6 rounded-2xl bg-white dark:bg-slate-800/90 border border-slate-200/80 dark:border-slate-700/70 shadow-soft space-y-4">
      <div>
        ...
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Historical cash flow trends over the last 6 months
        </p>
      </div>
      ...
      <div className="h-64 w-full pt-2">
        <ResponsiveContainer width="100%" height="100%">
          ...
          >
            ...
            />
            <Bar dataKey="income" name="Income" fill="#6366f1" radius={[4, 4, 0, 0]} maxBarSize={24} />
